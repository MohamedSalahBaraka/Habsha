...
export default function OrderDelivaryForBisnesses() {
  ...
  const sendForm = useCallback(async () => {
    try {
      ...
      await CartService.placeDelivary(
        { city, citysent, details, detailssent, name, namesent, neighbourhood, neighbourhoodsent, phone, phonesent, title, money: parseInt(money) },
        config
      );
  ...
  }, [city, citysent, details, detailssent, name, namesent, neighbourhood, neighbourhoodsent, phone, phonesent, title, money]);
      ...
      {isLoaded ? (
        <>
          <ScrollView>
            ...
            >
              <Text style={[barakocta.tRight, { color: Colors.tertiary, fontFamily: "Cairo", fontSize: 20 }]}>طلبات التوصيل للاعمال</Text>
              ...
              <View style={[barakocta.jcCenter, barakocta.mt3, barakocta.mb0, barakocta.aiCenter]}>
                <Text style={[{ fontFamily: "Cairo" }]}>المبالغ المستلمة</Text>
                <TextInput
